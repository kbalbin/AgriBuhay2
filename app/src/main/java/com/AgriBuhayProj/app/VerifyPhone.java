...
//TODO: CHANGE NAME (VerifyPhone - VerifyPhoneRetailer same with other VerifyPhone)
public class VerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReusableCodeForAll.ShowAlert(VerifyPhone.this, "PHONE NUMBER ENTERED", phoneNumber);
                ...
                if (task.isSuccessful()) {
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface sDialog, int i) {
                            //Direct to Main
                            startActivity(new Intent(VerifyPhone.this, MainMenu.class));
                            finish();
                        }
                    });
