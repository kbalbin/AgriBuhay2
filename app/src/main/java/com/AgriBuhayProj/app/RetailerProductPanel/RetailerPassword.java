...
public class RetailerPassword extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        user.updatePassword(ne).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    FirebaseDatabase.getInstance().getReference("Retailer").child(userid).child("Password").setValue(ne);
                                                    FirebaseDatabase.getInstance().getReference("Retailer").child(userid).child("ConfirmPassword").setValue(conf);

                                                    Toast.makeText(RetailerPassword.this, "password updated", Toast.LENGTH_SHORT).show();
                                                } else {
                                                    Toast.makeText(RetailerPassword.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    } else {
                ...
                forgot.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent aa=new Intent(RetailerPassword.this, RetailerForgotpassword.class);
                        startActivity(aa);
                    }
                });
