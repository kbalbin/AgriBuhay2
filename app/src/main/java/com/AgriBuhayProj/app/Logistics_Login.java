    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                if (FAuth.getCurrentUser().isEmailVerified()) {
                                    ...
                                    Intent z = new Intent(Logistics_Login.this, Logistics_ProductPanelBottomNavigation.class);
                                    startActivity(z);
                                    finish();
        ...
        txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent Register = new Intent(Logistics_Login.this, Logistics_registration.class);
        ...
        Forgotpassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(Logistics_Login.this, Logistics_ForgotPassword.class);
                startActivity(a);
                finish();
        ...
        Signinphone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent q = new Intent(Logistics_Login.this, Logistics_LoginPhone.class);
                startActivity(q);
                finish();
            }
        });
