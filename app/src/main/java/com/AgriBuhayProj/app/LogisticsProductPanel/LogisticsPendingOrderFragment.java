...
public class LogisticsPendingOrderFragment extends Fragment {
    ...
    private void LogisticsPendingOrders() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("LogisticsShipOrders").child(deliveryId);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        DatabaseReference data = FirebaseDatabase.getInstance().getReference("LogisticsShipOrders").child(deliveryId).child(snapshot.getKey()).child("OtherInformation");
