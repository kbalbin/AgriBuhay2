...
public class Logistics_ShippingOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProducerName = (TextView) findViewById(R.id.chefname2);
                ...
                Shipped.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        FirebaseDatabase.getInstance().getReference("RetailerFinalOrders").child(userid).child(randomuid).child("OtherInformation").child("Status").setValue("Your Order is delivered").addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            @Override
                            public void onSuccess(Void aVoid) {
                                AlertDialog.Builder builder = new AlertDialog.Builder(Logistics_ShippingOrder.this);
                                ...
                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        dialog.dismiss();
                                        Intent intent = new Intent(Logistics_ShippingOrder.this, Logistics_ProductPanelBottomNavigation.class);
            ...
            public void onResponse(retrofit2.Call<MyResponse> call, Response<MyResponse> response) {
                if (response.code() == 200) {
                    if (response.body().success != 1) {
                        Toast.makeText(Logistics_ShippingOrder.this, "Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            }
