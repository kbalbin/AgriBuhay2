...
public class LogisticsPendingOrderView extends AppCompatActivity {
    ...
    private void logisticsorders() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("LogisticsShipOrders").child(deliveryId).child(RandomUID).child("Products");
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("LogisticsShipOrders").child(deliveryId).child(RandomUID).child("OtherInformation");
