        ...
        try {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (FAuth.getCurrentUser().isEmailVerified()) {
                                        ...
                                        Intent z = new Intent(ProducerLogin.this, ProducerProductPanel_BottomNavigation.class);
                                        startActivity(z);
                                        finish();
            ...
            txt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent Register = new Intent(ProducerLogin.this, Producer_Registration.class);
            ...
            Forgotpassword.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent a = new Intent(ProducerLogin.this, ProducerForgotPassword.class);
                    startActivity(a);
                    finish();
            ...
            Signinphone.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent q = new Intent(ProducerLogin.this, Producerloginphone.class);
                    startActivity(q);
                    finish();
                }
            });
