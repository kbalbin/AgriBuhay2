...
public class ProducerFinalOrders1 {
    ...
    public ProducerFinalOrders1(String address, String grandTotalPrice, String mobileNumber, String name, String randomUID, String status) {
        Address = address;
