...
public class Producer_PostProduct extends AppCompatActivity {
    ...
    private void uploadImage() {
        ...
        if (imageuri != null) {
            final ProgressDialog progressDialog = new ProgressDialog(Producer_PostProduct.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            firebaseDatabase.getInstance().getReference("ProductSupplyDetails").child(State).child(City).child(sub).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Producer_PostProduct.this, "Product posted successfully", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(Producer_PostProduct.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
