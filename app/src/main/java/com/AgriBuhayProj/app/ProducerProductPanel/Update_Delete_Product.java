...
public class Update_Delete_Product extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Productname = (TextView) findViewById(R.id.productt_name);
        imageButton = (ImageButton) findViewById(R.id.imageupload);
        Update_product = (Button) findViewById(R.id.Updatedish);
        Delete_product = (Button) findViewById(R.id.Deletedish);
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //TODO this is the database for the FoosuplyDetails DONE
                                ...
                                AlertDialog.Builder food = new AlertDialog.Builder(Update_Delete_Product.this);
                                food.setMessage("Your Product has been Deleted");
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {

                                        startActivity(new Intent(Update_Delete_Product.this, ProducerProductPanel_BottomNavigation.class));
                                    }
                                });
                ...
                progressDialog = new ProgressDialog(Update_Delete_Product.this);
                //TODO this is the database for the FoodSupplyDetails DONE
                ...
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Glide.with(Update_Delete_Product.this).load(updateProductModel.getImageURL()).into(imageButton);
        ...
        if (imageuri != null) {
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(Update_Delete_Product.this, "Failed : " + e.getMessage(), Toast.LENGTH_LONG).show();
                }
    ...
    private void updatedesc(String uri) {
        ...
        firebaseDatabase.getInstance().getReference("ProductSupplyDetails").child(State).child(City).child(Sub)
            ...
            public void onComplete(@NonNull Task<Void> task) {
                progressDialog.dismiss();
                Toast.makeText(Update_Delete_Product.this, "Product Updated Successfully", Toast.LENGTH_SHORT).show();
            }
        });
    }
