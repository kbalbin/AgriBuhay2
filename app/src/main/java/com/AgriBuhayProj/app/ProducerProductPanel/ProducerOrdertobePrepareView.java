...
public class ProducerOrdertobePrepareView extends AppCompatActivity {
    ...
    private ProducerOrdertobePrepareViewAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grandtotal = findViewById(R.id.pesos);
    ...
    private void ProducerorderproductsView() {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    data.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            ...
                                            hashMap1.put("Status", "Farmer is preparing your Order...");
                                            ...
                                            FirebaseDatabase.getInstance().getReference("ProducerFinalOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("OtherInformation").setValue(hashMap1).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    ...
                                                    FirebaseDatabase.getInstance().getReference("RetailerFinalOrders").child(userid).child(RandomUID).child("OtherInformation").child("Status").setValue("Farmer is preparing your order...").addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        @Override
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            //TODO this is the database for the ChefWaitingOrders DONE
                ...
                adapter = new ProducerOrdertobePrepareViewAdapter(ProducerOrdertobePrepareView.this, producerWaitingOrdersList);
